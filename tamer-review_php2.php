...
<body id="reviewb">
    ...
    <?php
    // Array met de game data voor de opdracht
    $gamesCatalogus = [
        "game1" => [
    ...
    // Ophalen van de keuze uit de URL parameters
    $keuze = '1';
    if (isset($_GET['keuze'])) {
        $keuze = $_GET['keuze'];
    }
    ...
    // Als keuze 2 is, laat game 2 zien, anders game 1
    if ($keuze == '2') {
    ...
    <main class="container">
        ...
        <article class="card" id="review" style="display: flex; flex-direction: column; max-width: 800px; margin: 0 auto; padding: 20px;">
            ...
            <article style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 20px;">
                <!-- Grid weergave voor de plaatjes -->
